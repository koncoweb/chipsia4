...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: A4aUfL_OVYM/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: JK6heZL86XJ/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__rmp2Z)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__kw4Tn)}
              />
            </React.Fragment>
          ),
          value: args.children
