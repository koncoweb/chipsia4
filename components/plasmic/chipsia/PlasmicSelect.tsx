...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: ege3fRU_qJ2/component
import Select__Option from "../../Select__Option"; // plasmic-import: TVyhejT7Qla/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: A4aUfL_OVYM/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: JK6heZL86XJ/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: YZJyhTwdBvmxzZ/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: ptCGSmYMtdK6ex/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__s8OMj)}
              value={"value1" as const}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option__eFrph)}
              value={"value2" as const}
            >
              {"Option 2"}
            </Select__Option>
